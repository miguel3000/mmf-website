    ...
    <div className="min-h-screen bg-white dark:bg-bg-dark">
      <div className="max-w-lg mx-auto px-6 py-12">
        ...
        <div className="text-center space-y-4 mb-8">
          ...
          <a
            href="https://wa.me/31653117778?text=Hoi%20Michiel%2C%20ik%20heb%20iets%20van%20je%20gevonden%20via%20de%20QR-code%20op%20je%20apparatuur."
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center gap-3 bg-primary dark:bg-white text-white dark:text-bg-dark font-heading text-2xl tracking-wider px-8 py-4 rounded-full hover:bg-secondary dark:hover:bg-white/80 transition-colors w-full max-w-sm mx-auto"
          >
